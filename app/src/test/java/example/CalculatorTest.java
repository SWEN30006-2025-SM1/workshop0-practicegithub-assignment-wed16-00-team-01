...
public class CalculatorTest {
    ...
    @Test
    public void testMinusWithNegative() { Assert.assertEquals(20, calculator.minus(15, -5)); }
    @Test
    public void testMultiplyBasic() { Assert.assertEquals(10, calculator.multiply(2, 5)); }
    @Test
    public void testMultiplyWithNegative() { Assert.assertEquals(-15, calculator.multiply(15, -1)); }
    @Test
